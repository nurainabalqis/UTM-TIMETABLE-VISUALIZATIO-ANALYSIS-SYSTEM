...
function buildingFromRoom(room) {
    return room.startsWith("N28A") ? "N28A" : "N28";
}
...
function renderCharts(){
    ...
    function drawAllCharts(){
        ...
        const dayChart = new google.visualization.ColumnChart(document.getElementById('dayChart'));
        dayChart.draw(dayData, dayOptions);
    }
}

console.log(" TTMS Clash Detection loaded. Click 'Load TTMS Data' to start.");

window.onload = loadAllSubjects;

// -----------------------
// AUTO LOAD FOR DYNAMIC NAVIGATION
// -----------------------

// Highlight: this is the new part you add
if (document.readyState === "complete") {
    // Page is fully loaded, safe to call
    loadAllSubjects();
} else {
